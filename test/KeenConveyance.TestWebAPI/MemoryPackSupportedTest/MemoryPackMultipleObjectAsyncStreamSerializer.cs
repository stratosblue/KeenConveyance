...
public sealed class MemoryPackMultipleObjectAsyncStreamSerializer : IMultipleObjectAsyncStreamSerializer
{
    // 仅做可行性验证，可优化内存使用
    ...
    public MemoryPackMultipleObjectAsyncStreamSerializer(Stream stream)
    {
